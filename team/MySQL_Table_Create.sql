...
UNION SELECT 'Brian_Bessler@compaid.com', 'Brian', 'Bessler', SHA2('password', 256), SHA2('token', 256)
UNION SELECT 'Ivan_Polupan@compaid.com', 'Ivan', 'Polupan', SHA2('password', 256), SHA2('token', 256)
UNION SELECT 'Angel_Esparza@compaid.com', 'Angel', 'Esparza', SHA2('password', 256), SHA2('token', 256)
UNION SELECT 'DeAnthony_McKenzie@compaid.com', 'DeAnthony', 'McKenzie', SHA2('password', 256), SHA2('token', 256)
